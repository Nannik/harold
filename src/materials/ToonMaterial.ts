...
// Note that the material classes in this assignment implement the same functionality
// as Assignment 5, and you could plug in your own implementations if you prefer.
// We have added an (obfuscated) instructors' implementation to the Assignment 6
...
export class ToonMaterial extends gfx.Material3
{
    ...
    draw(mesh: gfx.Mesh3, camera: gfx.Camera, lightManager: gfx.LightManager): void
    {
        ...
        this.gl.uniform1i(this.diffuseRampUniform, 0);
        
        this.gl.activeTexture(this.gl.TEXTURE1)
        this.gl.bindTexture(this.gl.TEXTURE_2D, this.specularRamp.texture);
        this.gl.uniform1i(this.specularRampUniform, 1);
